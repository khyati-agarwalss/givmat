...
With blockchain, with the help of distributed ledger system, votes could be verified right after the voting is finished, so that officials can be certain that the votes are counted correctly and there are no security breaches at risk.
